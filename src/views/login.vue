    ...
    <div class="content">
      ...
      <div class="form_box">
        <div class="login_form">
          ...
          <el-form :model="formData" :rules="formRules" label-position="left" ref="the-form">
            <el-form-item prop="account">
              <el-input :placeholder="formRules.account[0].message" v-model="formData.account"/>
            </el-form-item>
            <el-form-item prop="password">
              <el-input :placeholder="formRules.password[0].message"
            ...
            <el-form-item>
              <div class="mgb_10">
                <el-button :loading="loading" @click="onLogin(false)" style="width: 100%" type="primary">登录</el-button>
              </div>
              <el-checkbox v-model="remember">记住账号/密码</el-checkbox>
            </el-form-item>
          </el-form>
          <div :key="index" class="tips flex fvertical" v-for="(item, index) in tipList">
            <el-button size="mini" type="success" v-copy="item">点击复制</el-button>
            <div class="tips_text f1">账号: {{ item }}; 密码: 随便填</div>
            <el-button @click="setLoginInfo(item)" size="mini" type="primary">一键登录</el-button>
          </div>
        </div>
      </div>
